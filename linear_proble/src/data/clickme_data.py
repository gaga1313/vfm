...
class ClickMe(Dataset):
    ...
    def __init__(self, image_folder, label_to_category_map, is_training=True):
        ...
        if is_training:
            ...
            text_file = "/files22_lrsresearch/CLPS_Serre_Lab/projects/prj_video_imagenet/co3d-harmonization-pytorch/data_lists/co3d_train.txt" # Text file with all the training images
        ...
        # Process Validation data
            ...
            text_file = "/files22_lrsresearch/CLPS_Serre_Lab/projects/prj_video_imagenet/co3d-harmonization-pytorch/data_lists/co3d_val.txt" # Text file with all the validation images
