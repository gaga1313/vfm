...
class OrigPlank5(Dataset):
    ...
    def __getitem__(self, index: int):
        ...
        positions = np.zeros(32, dtype = np.float32)
        positions[:16] = x_new_positions[:16]
        positions[16:] = y_new_positions[:16]
...
#     train_dataset = OrigPlank5("/cifs/data/tserre_lrs/projects/projects/prj_vis_sim/plankdatasets/originalv1/train", train = True, is_val = False, transform = transform, noise = True)
#     val_dataset = OrigPlank5("/cifs/data/tserre_lrs/projects/projects/prj_vis_sim/plankdatasets/originalv1/train", train = False, is_val = True, transform = transform, noise = True)
