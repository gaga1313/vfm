...
#     train_dataset = OrigPlank3("/cifs/data/tserre_lrs/projects/projects/prj_vis_sim/plankdatasets/originalv1/train", train = False, transform = transform, noise = True)
