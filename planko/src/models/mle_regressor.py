...
class ConvREG(nn.Module):
    ...
    def forward(self, image):
        ...
        outputs = torch.stack([head(encoded) for head in self.heads], dim=1)  # Shape: (batch_size, 16, 896)
    ...
    def inference(self, image, n_samples=100):
        ...
        # Encode image
        encoded = self.encoder_fc(self.image_encoder1(image))  # Ensure image_encoder2 can handle this shape
