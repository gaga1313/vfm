        ...
        for step, (images, labels, pos, board) in enumerate(progress_bar):
            ...
            if (step + 1) % log_interval == 0:
                ...
                if save_images and (step + 1) % 10 == 0:
                    logs['Test Images'] = plot_trajectory(model, images[:12], pos[:12], n_samples=1)
...
def main():
    ...
    test_dataset = OrigPlank5("/cifs/data/tserre_lrs/projects/projects/prj_vis_sim/plankdatasets/singbaskv3/test", train = False, is_val = False, transform = transform, noise = noise, norm = normalization)
